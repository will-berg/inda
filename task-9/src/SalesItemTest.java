...
public class SalesItemTest
{
    ...
    {
        SalesItem salesIte1 = new SalesItem("item", 2500);
        assertEquals(true, salesIte1.addComment("William Berg", "good item", 4));
        assertEquals(false, salesIte1.addComment("William Berg", "bad item", 2));
        assertEquals(1, salesIte1.getNumberOfComments());
    }
    ...
    {
        SalesItem salesIte2 = new SalesItem("item2", 50);
        assertEquals(false, salesIte2.addComment("William", "super item", 6));
        assertEquals(false, salesIte2.addComment("William", "terrible item", 0));
